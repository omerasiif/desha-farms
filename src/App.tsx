      ...
      <main>
        ...
        <section className="intro section-pad" id="about">
          <div className="intro-inner page-width">
            <div className="intro-visual">
              <div className="intro-label eyebrow"><span /> Welcome to Desha Farmhouse</div>
        ...
        <section className="highlights section-pad" id="amenities">
          <div className="page-width">
            <div className="section-heading">
              <div className="eyebrow"><span /> The Desha feeling</div>
        ...
        <section className="marquee-section section-pad" id="gallery">
          <div className="marquee-intro page-width">
            <div className="eyebrow"><span /> A glimpse of Desha farm</div>
      ...
      <footer className="footer">
        <div className="page-width footer-grid">
          ...
          <div className="footer-contact">
            ...
            <a href="mailto:hello@btsfarmhouse.com"><MessageCircle size={15} /> hello@deshafarmhouse.com</a>
          </div>
        </div>
        <div className="footer-bottom page-width">
          <span>© 2026 Desha Farmhouse. All rights reserved.</span>
